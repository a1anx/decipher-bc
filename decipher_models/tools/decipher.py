...
from decipher_models.plot.decipher import decipher as plot_decipher_v
from decipher_models.tools._decipher import Decipher, DecipherConfig
...
# Stale references to the old `decipher` package name; decipher_models has its own copies of these.
...
from decipher_models.tools.utils import EarlyStopping
from decipher_models.utils import (
    DECIPHER_GLOBALS,
    GIFMaker,
    is_notebook,
    load_and_show_gif,
