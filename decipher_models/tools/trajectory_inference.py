...
from decipher_models.tools._decipher.data import decipher_load_model
from decipher_models.utils import create_decipher_uns_key
...
def decipher_time(adata, n_neighbors=10):
    ...
    for name, trajectory in adata.uns["decipher"]["trajectories"].items():
        ...
        adata.obs.iloc[cells_on_trajectory_idx, adata.obs.columns.get_loc("decipher_time")] = (
            predicted
        )
