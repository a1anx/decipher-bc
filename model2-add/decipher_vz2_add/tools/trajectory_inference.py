...
from decipher_vz2_add.tools._decipher.data import decipher_load_model
from decipher_vz2_add.utils import create_decipher_uns_key
...
def decipher_time(adata, n_neighbors=10):
    ...
    for name, trajectory in adata.uns["decipher"]["trajectories"].items():
        ...
        """
        Previous code triggers pandas version incompatibility
        Mismatch between numpy array and row label
